...
public class NewDailyActivity extends AppCompatActivity {
    ...
    //URLs
    private String urlShowFriend="http://jennyk97.dothome.co.kr/ShowFriend.php";
    private String urlDailyGroupInfo="http://jennyk97.dothome.co.kr/DailygroupInfo.php";
    private String urlNewDaily= "http://jennyk97.dothome.co.kr/NewDaily.php";
