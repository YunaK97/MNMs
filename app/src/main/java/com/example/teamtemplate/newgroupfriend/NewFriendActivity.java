...
public class NewFriendActivity extends AppCompatActivity {
    ...
    //URLs
    private String urlNewFriendAdd="http://jennyk97.dothome.co.kr/NewFriendAdd.php";
    private String urlRequestedFriend="http://jennyk97.dothome.co.kr/RequestedFriend.php";
    private String urlRequestedResult="http://jennyk97.dothome.co.kr/RequestedResult.php";
    private String urlDeleteFriend="http://jennyk97.dothome.co.kr/DeleteFriend.php";
    private String urlNewFriend="http://jennyk97.dothome.co.kr/NewFriend.php";
    //variables
